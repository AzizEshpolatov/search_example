            ...
            children: [
              Padding(
                ...
                child: TextField(
                  onChanged: (v) {
                    ...
                    context
                        .read<SearchBloc>()
                        .add(SearcherEvent(searchText: v));
                    setState(() {});
                  },
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [Text("Data:${state.allData.length}")],
                ),
              ),
              Expanded(
                          ...
                          : RichText(
                              text: TextSpan(
                                  ...
                                  TextSpan(
                                    ...
                                    text: state.allData[index].name.substring(
                                        searchText.length,
                                        state.allData[index].name.length),
                                  )
                                ])),
                    );
                  },
